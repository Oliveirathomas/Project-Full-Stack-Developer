...
namespace Project_Full_Stack_Developer.Controllers
{
    public class DirectorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,NumberMovies,Rating,Oscars")] Director director)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,NumberMovies,Rating,Oscars")] Director director)
        {
            if (id != director.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.Director'  is null.");
            }
            var director = await _context.Director.FindAsync(id);
            if (director != null)
            {
