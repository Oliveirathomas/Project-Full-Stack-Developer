...
namespace Project_Full_Stack_Developer.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Rating,Oscars")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Rating,Oscars")] Actor actor)
        {
            if (id != actor.Id)
            {
                return NotFound();
